...
def check_and_download_image_assets():
    ...
    progress = QProgressDialog("Baixando Imagens de Chefes...", "Cancelar", 0, 100, None)
    progress.setWindowModality(Qt.WindowModality.ApplicationModal)
    progress.setWindowTitle("Baixando Imagens")
    ...
    try:
        ...
        progress.setLabelText("Extraindo imagens...")
        ...
        progress.close()
        error_message = f"Falha ao baixar ou extrair imagens de chefes: {e}\nAs imagens de chefes não estarão disponíveis."
        print(error_message)
        QMessageBox.critical(None, "Erro de Recursos", error_message)
