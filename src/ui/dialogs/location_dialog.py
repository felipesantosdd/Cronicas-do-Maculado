...
class LocationDialog(QDialog):
    ...
    def __init__(self, boss_data, parent=None):
        ...
        self.setWindowTitle(f"Localização: {self.boss_data.get('name', 'N/A')}")
    ...
    def _init_ui(self):
        ...
        if image_path:
            ...
            if not pixmap.isNull():
                ...
                image_label.setText(f"Imagem não encontrada em:\n{error_path_display}")
        else:
            image_label.setText("Nenhuma imagem de localização disponível para este chefe.")
