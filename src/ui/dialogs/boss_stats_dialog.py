...
class BossStatsDialog(QDialog):
    ...
    def __init__(self, boss_data, parent=None):
        ...
        self.setWindowTitle(f"Detalhes: {self.boss_data.get('name', 'N/A')}")
    ...
    def _create_stats_widget(self, name, stats):
        ...
        negation_group = QGroupBox("Negação de Dano")
        ...
        resistances_group = QGroupBox("Resistências")
