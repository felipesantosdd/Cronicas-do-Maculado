...
class DownloadProgressDialog(QDialog):
    ...
    def update_progress(self, value):
        ...
        if value >= 100:
            self.status_label.setText("Download concluído! Verificando...")
    ...
    def set_completed(self):
        ...
        self.status_label.setText("Atualização baixada! Clique em 'Instalar Agora' para iniciar a instalação.")
        self.progress_bar.setValue(100)
        self.cancel_button.setText("Instalar Agora")
