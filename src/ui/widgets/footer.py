...
class FooterWidget(QFrame):
    def __init__(self, parent=None):
        ...
        feature_request_label = QLabel('💡 <a href="https://github.com/RysanekDavid/The-Tarnished-Chronicle/issues/new?assignees=&labels=enhancement&projects=&template=&title=Feature%20Request%3A%20" style="color: #81A1C1; text-decoration: underline;">Solicitar Recurso</a>')
        ...
        credit_label = QLabel('Feito com <span style="color: #ff0000;">♥</span> por <a href="https://github.com/RysanekDavid" style="color: #5B90C5;">Davosso</a>')
