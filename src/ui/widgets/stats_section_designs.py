...
class DefaultStatsDesign(BaseStatsDesign):
    def __init__(self, parent=None):
        ...
        # Table Rows
        self.base_game_labels = self._create_row("Jogo Base", 1)
        ...
        # General Stats
        self.playtime_label = self._create_general_stat(get_resource_path("assets/icons/clock.svg"), "Tempo de Jogo:", 5)
        self.deaths_label = self._create_general_stat(get_resource_path("assets/icons/skull-and-crossbones.svg"), "Mortes:", 6)
...
class CompactStatsDesign(BaseStatsDesign):
    def __init__(self, parent=None):
        ...
        self.playtime_label = self._create_stat_label(get_resource_path("assets/icons/clock.svg"), "Tempo de Jogo")
        self.deaths_label = self._create_stat_label(get_resource_path("assets/icons/skull-and-crossbones.svg"), "Mortes")
        self.bosses_label = self._create_stat_label(None, "Chefes")
