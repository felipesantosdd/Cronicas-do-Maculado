...
class EmptyStateWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Title
        self.title_label = QLabel("Bem-vindo à Lista de Chefes do ER")
        self.title_label.setObjectName("emptyStateTitle")
        self.title_label.setAlignment(Qt.AlignmentFlag.AlignCenter)

        # Instructional Text
        self.instruction_label = QLabel("Para começar, selecione seu arquivo de save do Elden Ring (.sl2 para Vanilla ou .co2 para Seamless Coop).")
    ...
    def set_state(self, state: str):
        ...
        if state == "select_file":
            ...
            self.title_label.setText("Arquivo de Save Carregado!")
            self.instruction_label.setText("Ótimo! Agora, selecione um personagem na lista suspensa do menu à esquerda para visualizar seu progresso.")