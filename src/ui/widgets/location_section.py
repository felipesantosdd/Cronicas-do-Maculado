...
class LocationSectionWidget(QFrame):
    ...
    def _init_ui(self):
        ...
        self.boss_table.setHorizontalHeaderLabels(["Chefe / Evento", "Status", "Horário", "Stats do Chefe", "Localização"])
    ...
    def _populate_boss_table(self):
        ...
        for row, boss_info in enumerate(self.bosses_data):
            ...
            if boss_info.get("stats"):
                ...
                details_label.setToolTip("Mostrar detalhes do chefe")
                ...
                details_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
                details_label.setToolTip("Estatísticas não disponíveis para este chefe")
                self.boss_table.setCellWidget(row, 3, details_label)
            ...
            location_label.setToolTip("Mostrar no mapa (funcionalidade ainda não implementada)")
