...
class BossChecklistApp(QWidget):
    ...
    def _init_ui(self):
        ...
        if os.path.exists(saved_path):
            ...
            self.save_file_path_label.setText("Por favor, selecione um arquivo de save...")
            self.character_slot_combobox.clear()
            self.character_slot_combobox.setPlaceholderText("Selecione um personagem")
    ...
    def _create_content_area(self):
        ...
        self.toggle_overlay_button = QPushButton("Ativar Overlay")
        self.toggle_overlay_button.setCheckable(True)
        top_buttons_layout.addWidget(self.toggle_overlay_button)
        self.overlay_settings_button = QPushButton("Config. do Overlay")
        top_buttons_layout.addWidget(self.overlay_settings_button)
        self.obs_settings_button = QPushButton("Overlay OBS")
        ...
        self.search_bar.setPlaceholderText("Buscar chefe ou localização...")
    ...
    def show_update_dialog(self, manifest_data: dict):
        ...
        msg_box.setText(f"<b>Uma nova versão ({version}) está disponível.</b>")
        msg_box.setInformativeText(f"<b>Notas de Lançamento:</b>\n{notes}\n\nDeseja baixar e instalar agora?")
        ...
        if msg_box.exec() == QMessageBox.StandardButton.Yes:
            if url:
                ...
                QMessageBox.warning(self, "Erro", "URL de download ausente no manifesto de atualização.")
